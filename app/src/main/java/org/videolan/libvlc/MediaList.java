...
public class MediaList
{
    ...
    private static class MediaHolder
    {
        ...
        public MediaHolder(Media m_, boolean noVideo_,
                boolean noHardwareAcceleration_)
        {
            m = m_;
            noVideo = noVideo_;
    ...
    public void clear()
    {
        ...
        {
            signal_list_event(EventHandler.CustomMediaListItemDeleted,
                    i,
    ...
    public int expandMedia(int position)
    {
        ...
        if (ret == 0)
        {
            mEventHandler.callback(EventHandler.CustomMediaListExpanding,
                    new Bundle());
            ...
            mEventHandler.callback(EventHandler.CustomMediaListExpandingEnd,
                    new Bundle());
        }
        return ret;
    }
