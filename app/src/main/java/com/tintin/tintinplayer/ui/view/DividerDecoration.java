...
public class DividerDecoration extends RecyclerView.ItemDecoration
{
    ...
    public void drawVertical(Canvas c, RecyclerView parent)
    {
        ...
        final int recyclerViewBottom = parent.getHeight()
        ...
        for (int i = 0; i < childCount; i++)
        {
            ...
            final int top = Math.max(recyclerViewTop, child.getBottom()
                    + params.bottomMargin);
            final int bottom = Math.min(recyclerViewBottom,
    ...
    public void drawHorizontal(Canvas c, RecyclerView parent)
    {
        ...
        final int recyclerViewRight = parent.getWidth()
        ...
        for (int i = 0; i < childCount; i++)
        {
            final View child = parent.getChildAt(i);
            final RecyclerView.LayoutParams params = (RecyclerView.LayoutParams) child.getLayoutParams();
            final int left = Math.max(recyclerViewLeft, child.getRight()
                    + params.rightMargin);
            final int right = Math.min(recyclerViewRight,
